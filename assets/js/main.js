...
const translations = {
  ru: {
    ...
    "hero.heading": "NITRO VPN — VLESS VPN для YouTube, Telegram, Instagram и КиноПоиск",
    ...
    "meta.title": "NITRO VPN — VLESS VPN для YouTube, Telegram, Instagram и КиноПоиск",
  ...
  en: {
    ...
    "hero.heading": "NITRO VPN — VLESS VPN for YouTube, Telegram, Instagram and Kinopoisk",
    ...
    "footer.copyright": "© <span id=\"year\"></span> NITRO VPN",
    "meta.title": "NITRO VPN — fast VLESS VPN for YouTube and Telegram",
  ...
  fa: {
    ...
    "hero.heading": "NITRO VPN — وی‌پی‌ان VLESS برای یوتیوب، تلگرام، اینستاگرام و KinoPoisk",
    ...
    "footer.copyright": "© <span id=\"year\"></span> NITRO VPN",
    "meta.title": "NITRO VPN — وی‌پی‌ان VLESS سریع برای یوتیوب و تلگرام",
  ...
  zh: {
    ...
    "hero.heading": "NITRO VPN — 畅享 YouTube、Telegram、Instagram 和 KinoPoisk 的 VLESS VPN",
    ...
    "cta.secondary": "支付方式",
    "footer.copyright": "© <span id=\"year\"></span> NITRO VPN",
    "meta.title": "NITRO VPN — 畅享 YouTube 和 Telegram 的 VLESS VPN",
