...
const translations = {
  ru: {
    ...
    "hero.heading": "NITRO VPN — VLESS VPN для YouTube, Telegram, Instagram и КиноПоиск в России",
    "hero.lead": "Запускайте YouTube, Instagram, TikTok, Telegram, WhatsApp и КиноПоиск без блокировок. Серверы в <b>Москве</b> и <b>Риге</b>, VLESS поверх TLS и продвинутый обход DPI дают стабильный и быстрый интернет.",
    "hero.savings": "Экономьте до 44% на подписке и получайте стабильный доступ к контенту из РФ и ЕС.",
    ...
    "hero.statusNote": "Средние показатели по клиентам из России и Европы. Реальный пинг зависит от провайдера и загрузки сети.",
    "features.heading": "Почему выбирают NITRO VPN",
    "features.subheading": "Надёжный доступ к стримингам, мессенджерам и соцсетям без блокировок, пробный период 2 дня и 1 ГБ для каждого нового пользователя.",
    "features.cardCinemaTitle": "КиноПоиск",
    "features.cardCinemaText": "Смотрите кино, сериалы, ТВ-каналы и спорт без региональных блокировок даже находясь не в России.",
    "features.cardYoutubeTitle": "YouTube",
    "features.cardYoutubeText": "Высокие скорости для 4K и прямых трансляций на любых устройствах.",
    "features.cardCallsTitle": "Звонки в месенджерах",
    "features.cardCallsText": "Аудио и видео звонки*¹ в Telegram, WhatsApp, Viber, FaceTime и др. проходят стабильно.",
    "features.cardInstagramTitle": "Instagram*²",
    "features.cardInstagramText": "Публикуйте и смотрите контент без ограничений.",
    "features.cardStealthTitle": "Скрытный трафик",
    "features.cardStealthText": "Соединение на VLESS маскируется под обычный HTTPS, поэтому блокировки его не замечают.",
    "features.cardDevicesTitle": "Одна подписка - 4 устройства",
    "features.cardDevicesText": "Одна подписка — любые четыре устройства: iPhone, Android, Mac, Windows, Linux.",
    "features.cardUnlimitedTitle": "Безлимитный трафик",
    "features.cardUnlimitedText": "Никаких скрытых ограничений или резкого снижения скорости.",
    "features.cardSpeedTitle": "Высокая скорость",
    "features.cardSpeedText": "Оптимизированные узлы в Москве и Риге обеспечивают высокую скорость и низкую сетевую задержку.",
    "features.cardSupportTitle": "Стабильность и поддержка",
    "features.cardSupportText": "99% аптайм и живой чат @nitro_vpn_help отвечает за пару минут.",
    "features.note": "*¹ Для голосовых звонков VPN должен быть включён у обоих абонентов.<br>*² Instagram принадлежит Meta, признанной в России экстремистской организацией.",
    "protocol.heading": "VLESS — простой ответ на вопрос «Почему у вас всё работает?»",
    "protocol.subheading": "VLESS — это современный протокол VPN. Он делает соединение быстрым, стабильным и незаметным для провайдера, поэтому любимые сервисы остаются доступны.",
    "protocol.cardWhatTitle": "Что это такое",
    "protocol.cardWhatText": "VLESS отвечает за то, как ваше устройство подключается к VPN. Он избавлен от «лишнего веса», поэтому соединение запускается за секунды и не тормозит интернет.",
    "protocol.cardFastTitle": "Почему быстрее",
    "protocol.cardFastText": "Протокол не добавляет лишних шагов при передаче данных. Видео, звонки и игры идут без провалов и подгрузок даже на нескольких устройствах сразу.",
    "protocol.cardStealthTitle": "Почему его не блокируют",
    "protocol.cardStealthText": "Трафик выглядит как обычное посещение сайта. Провайдеру нечего подозревать, поэтому сервисы остаются доступны даже при жёстких ограничениях.",
    "pricing.heading": "Тарифы и подписки",
    "pricing.subheading": "Гибкие планы на 1, 3, 6 и 12 месяцев. Любой тариф включает подключение до 4 устройств, безлимитный трафик и доступ к серверам в Москве и Риге.",
    ...
    "pricing.note": "Оплата картами банков РФ, по СБП или через Telegram Stars. Telegram-бот напомнит о продлении за несколько дней до окончания подписки.",
    "trial.heading": "Пробный период — бесплатно",
    "trial.lead": "<b>Новые пользователи</b> получают <b>2 дня</b> и <b>1 ГБ</b> трафика бесплатно. Активация занимает меньше минуты в Telegram — без банковской карты.",
    ...
    "trial.steps1": "Откройте бота <a href=\"https://t.me/nitro_vpn_sales_bot\" target=\"_blank\" rel=\"noopener\">@nitro_vpn_sales_bot</a>.",
    ...
    "trial.note": "Пробный период доступен один раз на пользователя, продлить можно любым платным тарифом.",
    "referral.heading": "Реферальная программа «Приведи друга»",
    "referral.subheading": "Если ваш друг оплачивает подписку — вы оба получаете дни в подарок к своей подписке.",
    ...
    "payments.subheading": "Принимаем карты банков РФ, СБП и платежи через Telegram Stars — доступ выдаётся сразу после оплаты.",
    "payments.cardCardsTitle": "Карты банков РФ",
    "payments.cardCardsText": "Оплата привычными картами с автоматическим подтверждением.",
    "payments.cardSbpTitle": "СБП",
    "payments.cardSbpText": "Мгновенная оплата без комиссии и переплат с вашего банковского счета.",
    "payments.cardStarsTitle": "Telegram Stars",
    "payments.cardStarsText": "Плати звёздами Telegram, если нет карты РФ или СБП.",
    ...
    "locations.moscowText": "Подходит для обхода ограничений в большинстве случаев, если вы в России.",
    "locations.rigaTitle": "Рига 🇱🇻",
    "locations.rigaText": "Подходит для обхода как внутренних, так и внешних ограничений и санкций.",
    ...
    "faq.a2": "Максимально возможная скорость на 1 сервер — 2 Гбит/сек, делится в равных пропорциях между всеми пользователями и искусственно не ограничивается. Реальная скорость зависит от вашего провайдера и расстояния до сервера.",
    "faq.q3": "Как работает пробный период?",
    "faq.a3": "2 дня и 1 ГБ трафика бесплатно. После исчерпания лимита можно перейти на любой тариф.",
    "faq.q4": "Где доступен сервис?",
    "faq.a4": "Сейчас доступны <b>Москва</b> и <b>Рига</b>. Мы добавляем новые локации по мере роста.",
    "cta.heading": "Готовы подключиться к NITRO VPN?",
    "cta.text": "Покупка, продление, пробный период и рефералы доступны в нашем Telegram-боте. Поддержка: <a class=\"support-link\" href=\"https://t.me/nitro_vpn_help\" target=\"_blank\" rel=\"noopener\">@nitro_vpn_help</a>",
    "cta.primary": "Открыть @nitro_vpn_sales_bot",
    "cta.secondary": "Способы оплаты",
    "footer.copyright": "© <span id=\"year\"></span> NITRO VPN",
    "meta.title": "NITRO VPN — VLESS VPN для YouTube, Telegram, Instagram и КиноПоиск в России",
    "meta.description": "Запускайте YouTube, Instagram, TikTok, Telegram, WhatsApp и КиноПоиск без блокировок. Серверы в Москве и Риге, VLESS поверх TLS, пробный период 2 дня и 1 ГБ, безлимитный трафик, до 4 устройств.",
    "meta.keywords": "nitro vpn,vless vpn,впн,впн россия,vpn russia,vpn латвия,vpn latvia,vpn москва,vpn moscow,vpn рига,vpn riga,быстрый vpn,stable vpn,vpn безлимит,vpn для youtube,vpn для instagram,vpn для facebook,vpn для tiktok,vpn для telegram,vpn для whatsapp,vpn для twitter,vpn для discord,vpn для viber,vpn для facetime,vpn для кинопоиск,vless protocol,обход dpi,secure vpn",
    "meta.ogLocale": "ru_RU",
    "meta.ogTitle": "NITRO VPN — VLESS VPN для YouTube и Telegram",
    "meta.ogDescription": "Доступ к YouTube, Instagram, TikTok, Telegram и WhatsApp. Серверы в Москве и Риге, VLESS поверх TLS, пробный период 2 дня и 1 ГБ.",
    "meta.ogImageAlt": "Логотип NITRO VPN и интерфейс приложения",
    "meta.twitterTitle": "NITRO VPN — VLESS VPN без блокировок",
    "meta.twitterDescription": "Тест 2 дня и 1 ГБ бесплатно. YouTube, Telegram, Instagram и КиноПоиск работают без ограничений, серверы в Москве и Риге.",
    ...
    "schema.description": "NITRO VPN — быстрый VLESS VPN-сервис для России и Европы с серверами в Москве и Риге, пробным периодом 2 дня и 1 ГБ, безлимитным трафиком и подключением до 4 устройств.",
  ...
  en: {
    ...
    "hero.heading": "NITRO VPN — VLESS VPN for YouTube, Telegram, Instagram and Kinopoisk in Russia",
    "hero.lead": "Access YouTube, Instagram, TikTok, Telegram, WhatsApp and Kinopoisk without blocks. Servers in <b>Moscow</b> and <b>Riga</b>, VLESS over TLS and advanced DPI bypass keep your internet fast and private.",
    "hero.savings": "Save up to 44% on long-term plans and stay connected in Russia and the EU.",
    ...
    "hero.statusEncryptionValue": "TLS + AES-256",
    "hero.statusNote": "Average values for customers in Russia and Europe. Actual latency depends on your ISP and network load.",
    "features.heading": "Why people choose NITRO VPN",
    "features.subheading": "Reliable access to streaming, messengers and social networks. Every new user gets a 2-day, 1 GB trial.",
    "features.cardCinemaTitle": "Kinopoisk",
    "features.cardCinemaText": "Watch movies, series, live TV and sports without regional blocks — even when you travel.",
    "features.cardYoutubeTitle": "YouTube",
    "features.cardYoutubeText": "High speeds for 4K videos and live streams on every device.",
    "features.cardCallsTitle": "Messenger calls",
    "features.cardCallsText": "Voice and video calls*¹ in Telegram, WhatsApp, Viber, FaceTime and more stay stable.",
    "features.cardInstagramTitle": "Instagram*²",
    "features.cardInstagramText": "Post and scroll without restrictions.",
    "features.cardStealthTitle": "Stealth traffic",
    "features.cardStealthText": "VLESS traffic looks like ordinary HTTPS, so blocks and DPI filters ignore it.",
    "features.cardDevicesTitle": "One plan for 4 devices",
    "features.cardDevicesText": "Use any four devices at once — iPhone, Android, Mac, Windows or Linux.",
    ...
    "features.cardSpeedText": "Optimised Moscow and Riga nodes keep latency low across Russia and the EU.",
    "features.cardSupportTitle": "Reliable support",
    "features.cardSupportText": "99% uptime and live help at @nitro_vpn_help replies within minutes.",
    "features.note": "*¹ Both sides need VPN enabled for voice calls.<br>*² Instagram is owned by Meta, recognised as an extremist organisation in Russia.",
    "protocol.heading": "VLESS — the simple reason everything keeps working",
    "protocol.subheading": "VLESS is a modern VPN protocol. It keeps connections fast, stable and invisible to providers, so your favourite services stay online.",
    "protocol.cardWhatTitle": "What it is",
    "protocol.cardWhatText": "VLESS handles how your device talks to the VPN. With no extra overhead it starts instantly and doesn’t slow the internet down.",
    "protocol.cardFastTitle": "Why it’s faster",
    "protocol.cardFastText": "The protocol avoids extra handshakes. Video, calls and games run smoothly even on multiple devices at once.",
    "protocol.cardStealthTitle": "Why it isn’t blocked",
    "protocol.cardStealthText": "Traffic looks like a normal website visit, so ISPs have nothing to flag and harsh blocks can’t stop it.",
    "pricing.heading": "Plans and pricing",
    "pricing.subheading": "Flexible 1, 3, 6 and 12 month plans. Every subscription includes 4 devices, unlimited data and access to Moscow and Riga servers.",
    ...
    "pricing.note": "Pay with Russian bank cards, SBP or Telegram Stars. The bot reminds you a few days before renewal.",
    "trial.heading": "Free trial — included",
    "trial.lead": "<b>New users</b> get <b>2 days</b> and <b>1 GB</b> of traffic for free. Activation takes under a minute in Telegram — no bank card needed.",
    ...
    "trial.steps1": "Open <a href=\"https://t.me/nitro_vpn_sales_bot\" target=\"_blank\" rel=\"noopener\">@nitro_vpn_sales_bot</a>.",
    ...
    "trial.note": "The trial is available once per user. Extend with any paid plan.",
    "referral.heading": "Referral program “Invite a friend”",
    "referral.subheading": "When your friend pays for a plan, you both receive extra days on top of your subscription.",
    ...
    "payments.subheading": "Pay with Russian bank cards, SBP or Telegram Stars — access is granted immediately after payment.",
    "payments.cardCardsTitle": "Russian bank cards",
    "payments.cardCardsText": "Pay with familiar cards and instant confirmation.",
    "payments.cardSbpTitle": "SBP",
    "payments.cardSbpText": "Instant bank payments with no extra fees.",
    "payments.cardStarsTitle": "Telegram Stars",
    "payments.cardStarsText": "Pay with Telegram Stars if you don’t have a Russian card or SBP.",
    ...
    "locations.moscowText": "Best choice for bypassing local restrictions across Russia.",
    "locations.rigaTitle": "Riga 🇱🇻",
    "locations.rigaText": "Ideal when you need both domestic and international access.",
    "faq.heading": "Frequently asked questions",
    "faq.q1": "How many devices can I connect?",
    "faq.a1": "Every plan includes up to <b>4 devices</b> online at the same time.",
    "faq.q2": "Are there any speed limits?",
    "faq.a2": "Each server handles up to 2 Gbit/s and shares it equally between users. Your real speed depends on your ISP and distance to the server.",
    "faq.q3": "How does the trial work?",
    "faq.a3": "You get 2 days and 1 GB for free. After that, switch to any paid plan.",
    "faq.q4": "Where is the service available?",
    "faq.a4": "Right now we run servers in <b>Moscow</b> and <b>Riga</b>. More locations are added as we grow.",
    "cta.heading": "Ready to connect to NITRO VPN?",
    "cta.text": "You can buy, renew, start the trial and manage referrals in our Telegram bot. Support: <a class=\"support-link\" href=\"https://t.me/nitro_vpn_help\" target=\"_blank\" rel=\"noopener\">@nitro_vpn_help</a>",
    "cta.primary": "Open @nitro_vpn_sales_bot",
    "cta.secondary": "Payment options",
    "footer.copyright": "© <span id=\"year\"></span> NITRO VPN",
    "meta.title": "NITRO VPN — fast VLESS VPN for YouTube and Telegram in Russia",
    "meta.description": "Access YouTube, Instagram, TikTok, Telegram, WhatsApp and Kinopoisk without blocks. Moscow and Riga servers, VLESS over TLS, 2-day 1 GB trial, unlimited traffic, 4 devices.",
    "meta.keywords": "nitro vpn,vless vpn,vpn russia,vpn moscow,vpn riga,fast vpn,unlimited vpn,vpn for youtube,vpn for telegram,vpn for instagram,vpn for whatsapp,vpn for twitter,vpn for discord,vpn bypass dpi,secure vpn",
    "meta.ogLocale": "en_US",
    "meta.ogTitle": "NITRO VPN — VLESS VPN for YouTube and Telegram",
    "meta.ogDescription": "Use YouTube, Instagram, TikTok, Telegram and WhatsApp freely. Moscow and Riga servers, VLESS over TLS, free 2-day 1 GB trial.",
    "meta.ogImageAlt": "NITRO VPN logo and app interface",
    "meta.twitterTitle": "NITRO VPN — unblock YouTube and Telegram",
    "meta.twitterDescription": "Try 2 days and 1 GB for free. Fast VLESS VPN with Moscow and Riga servers, unlimited data and 4 devices included.",
    ...
    "toast.planSelected": "Selected plan: {plan} — {price}. Please pay in Telegram.",
    "schema.description": "NITRO VPN is a fast VLESS VPN for Russia and Europe with servers in Moscow and Riga, a 2-day 1 GB trial, unlimited traffic and up to 4 devices.",
  ...
  fa: {
    ...
    "hero.eyebrow": "دو روز آزمایشی و ۱ گیگابایت رایگان — بدون نیاز به کارت بانکی",
    "hero.heading": "NITRO VPN — وی‌پی‌ان VLESS برای یوتیوب، تلگرام، اینستاگرام و KinoPoisk در روسیه",
    "hero.lead": "یوتیوب، اینستاگرام، تیک‌تاک، تلگرام، واتس‌اپ و KinoPoisk را بدون فیلتر باز کنید. سرورهای <b>مسکو</b> و <b>ریگا</b>، VLESS روی TLS و عبور پیشرفته از DPI، اینترنتی سریع و خصوصی فراهم می‌کند.",
    "hero.savings": "تا ۴۴٪ روی اشتراک‌های بلندمدت صرفه‌جویی کنید و در روسیه و اروپا آنلاین بمانید.",
    ...
    "hero.statusEncryptionValue": "TLS + AES-256",
    "hero.statusNote": "میانگین کاربران در روسیه و اروپا. سرعت واقعی به اینترنت شما و شلوغی شبکه بستگی دارد.",
    "features.heading": "چرا کاربران NITRO VPN را انتخاب می‌کنند",
    "features.subheading": "دسترسی بدون فیلتر به استریم، پیام‌رسان و شبکه‌های اجتماعی. برای هر کاربر جدید ۲ روز و ۱ گیگابایت آزمایشی.",
    "features.cardCinemaTitle": "KinoPoisk",
    "features.cardCinemaText": "فیلم، سریال، تلویزیون و ورزش را بدون محدودیت جغرافیایی تماشا کنید، حتی در سفر.",
    "features.cardYoutubeTitle": "YouTube",
    "features.cardYoutubeText": "سرعت بالا برای 4K و پخش زنده روی تمام دستگاه‌ها.",
    "features.cardCallsTitle": "تماس در پیام‌رسان‌ها",
    "features.cardCallsText": "تماس صوتی و تصویری*¹ در تلگرام، واتس‌اپ، وایبر، فیس‌تایم و ... پایدار است.",
    "features.cardInstagramTitle": "Instagram*²",
    "features.cardInstagramText": "بدون محدودیت پست بگذارید و محتوا ببینید.",
    "features.cardStealthTitle": "ترافیک مخفی",
    "features.cardStealthText": "VLESS شبیه HTTPS عادی است، بنابراین فیلترها و DPI آن را مسدود نمی‌کنند.",
    "features.cardDevicesTitle": "یک اشتراک برای ۴ دستگاه",
    "features.cardDevicesText": "چهار دستگاه مختلف را هم‌زمان متصل کنید: آیفون، اندروید، مک، ویندوز یا لینوکس.",
    ...
    "features.cardSpeedText": "سرورهای بهینه در مسکو و ریگا تاخیر را برای کاربران روسیه و اروپا پایین نگه می‌دارند.",
    "features.cardSupportTitle": "پشتیبانی سریع",
    "features.cardSupportText": "۹۹٪ آپ‌تایم و پشتیبانی زنده در @nitro_vpn_help طی چند دقیقه پاسخ می‌دهد.",
    "features.note": "*¹ برای تماس صوتی لازم است وی‌پی‌ان هر دو طرف روشن باشد.<br>*² اینستاگرام متعلق به Meta است که در روسیه سازمان افراطی شناخته می‌شود.",
    "protocol.heading": "VLESS — جواب ساده به اینکه چرا همه‌چیز کار می‌کند",
    "protocol.subheading": "VLESS پروتکل مدرن وی‌پی‌ان است. اتصال را سریع، پایدار و نامرئی برای اپراتور می‌کند تا سرویس‌های محبوب فیلتر نشوند.",
    "protocol.cardWhatTitle": "VLESS چیست؟",
    "protocol.cardWhatText": "VLESS نحوه ارتباط دستگاه شما با وی‌پی‌ان را مدیریت می‌کند. بدون سربار اضافی است و اتصال در چند ثانیه برقرار می‌شود.",
    "protocol.cardFastTitle": "چرا سریع‌تر است",
    "protocol.cardFastText": "پروتکل مراحل اضافی انتقال داده را حذف می‌کند. ویدئو، تماس و بازی بدون افت و تاخیر اجرا می‌شود.",
    "protocol.cardStealthTitle": "چرا مسدود نمی‌شود",
    "protocol.cardStealthText": "ترافیک مثل بازدید معمولی وب به نظر می‌رسد؛ بنابراین اپراتور چیزی برای مسدود کردن ندارد.",
    "pricing.heading": "طرح‌ها و قیمت‌ها",
    "pricing.subheading": "طرح‌های ۱، ۳، ۶ و ۱۲ ماهه. هر اشتراک شامل ۴ دستگاه، حجم نامحدود و سرورهای مسکو و ریگا است.",
    ...
    "pricing.note": "پرداخت با کارت‌های بانکی روسیه، سامانه پرداخت سریع یا Telegram Stars. ربات چند روز قبل از تمدید یادآوری می‌کند.",
    "trial.heading": "دوره آزمایشی رایگان",
    "trial.lead": "<b>کاربران جدید</b> <b>۲ روز</b> و <b>۱ گیگابایت</b> اینترنت رایگان دریافت می‌کنند. فعال‌سازی کمتر از یک دقیقه و بدون کارت بانکی است.",
    ...
    "trial.steps1": "ربات <a href=\"https://t.me/nitro_vpn_sales_bot\" target=\"_blank\" rel=\"noopener\">@nitro_vpn_sales_bot</a> را باز کنید.",
    ...
    "trial.note": "هر کاربر فقط یک بار می‌تواند از دوره آزمایشی استفاده کند. برای ادامه از یکی از طرح‌ها استفاده کنید.",
    "referral.heading": "برنامه معرفی «دوستت را بیاور»",
    "referral.subheading": "وقتی دوست شما اشتراک بخرد، هر دو نفر روزهای هدیه به اشتراک خود اضافه می‌کنید.",
    ...
    "payments.subheading": "کارت‌های بانکی روسیه، سامانه پرداخت سریع و Telegram Stars پذیرفته می‌شود — دسترسی بلافاصله فعال می‌شود.",
    ...
    "payments.cardStarsTitle": "Telegram Stars",
    "payments.cardStarsText": "اگر کارت یا SBP ندارید، با استارز تلگرام پرداخت کنید.",
    ...
    "faq.a2": "هر سرور تا ۲ گیگابیت در ثانیه ظرفیت دارد و بین کاربران تقسیم می‌شود. سرعت واقعی به اینترنت و فاصله شما بستگی دارد.",
    "faq.q3": "دوره آزمایشی چگونه است؟",
    "faq.a3": "۲ روز و ۱ گیگابایت رایگان است. پس از آن می‌توانید هر طرحی را بخرید.",
    "faq.q4": "خدمات کجا فعال است؟",
    "faq.a4": "در حال حاضر سرورها در <b>مسکو</b> و <b>ریگا</b> فعال هستند و به مرور اضافه می‌شوند.",
    "cta.heading": "آماده اتصال به NITRO VPN هستید؟",
    "cta.text": "خرید، تمدید، دوره آزمایشی و برنامه معرفی همگی در ربات تلگرام ماست. پشتیبانی: <a class=\"support-link\" href=\"https://t.me/nitro_vpn_help\" target=\"_blank\" rel=\"noopener\">@nitro_vpn_help</a>",
    "cta.primary": "باز کردن @nitro_vpn_sales_bot",
    "cta.secondary": "روش‌های پرداخت",
    "footer.copyright": "© <span id=\"year\"></span> NITRO VPN",
    "meta.title": "NITRO VPN — وی‌پی‌ان VLESS سریع برای یوتیوب و تلگرام در روسیه",
    "meta.description": "یوتیوب، اینستاگرام، تیک‌تاک، تلگرام، واتس‌اپ و KinoPoisk را بدون فیلتر باز کنید. سرورهای مسکو و ریگا، VLESS روی TLS، دوره آزمایشی ۲ روزه و ۱ گیگابایتی، حجم نامحدود و ۴ دستگاه.",
    "meta.keywords": "nitro vpn,vless vpn,وی پی ان روسیه,vpn moscow,vpn riga,fast vpn,وی پی ان بدون محدودیت,vpn برای یوتیوب,vpn برای تلگرام,vpn برای اینستاگرام,vpn whatsapp,vpn twitter,vpn discord,عبور از dpi",    
    "meta.ogLocale": "fa_IR",
    "meta.ogTitle": "NITRO VPN — وی‌پی‌ان VLESS برای یوتیوب و تلگرام",
    "meta.ogDescription": "یوتیوب، اینستاگرام، تیک‌تاک، تلگرام و واتس‌اپ بدون فیلتر. سرورهای مسکو و ریگا، دوره آزمایشی ۲ روزه و ۱ گیگابایت.",
    "meta.ogImageAlt": "لوگوی NITRO VPN و رابط کاربری",
    "meta.twitterTitle": "NITRO VPN — دسترسی بدون فیلتر",
    "meta.twitterDescription": "۲ روز و ۱ گیگابایت رایگان. وی‌پی‌ان VLESS با سرورهای مسکو و ریگا، حجم نامحدود و ۴ دستگاه.",
    ...
    "lang.option.fa": "🇮🇷 فارسی",
    "lang.option.zh": "🇨🇳 چینی",
    "toast.planSelected": "طرح انتخاب شده: {plan} — {price}. پرداخت در تلگرام انجام می‌شود.",
    "schema.description": "NITRO VPN یک وی‌پی‌ان سریع مبتنی بر VLESS برای روسیه و اروپا با سرورهای مسکو و ریگا، دوره آزمایشی ۲ روزه و ۱ گیگابایت، حجم نامحدود و تا ۴ دستگاه است.",
    "schema.moscow": "مسکو",
    "schema.riga": "ریگا",
  ...
  zh: {
    ...
    "hero.heading": "NITRO VPN — 在俄罗斯畅享 YouTube、Telegram、Instagram 和 KinoPoisk 的 VLESS VPN",
    "hero.lead": "畅通访问 YouTube、Instagram、TikTok、Telegram、WhatsApp 和 KinoPoisk。<b>莫斯科</b>与<b>里加</b>服务器，VLESS + TLS 及高级 DPI 绕过，让连接快速又隐私。",
    ...
    "hero.statusEncryptionValue": "TLS + AES-256",
    "hero.statusNote": "上述数据为俄罗斯及欧洲用户平均值，实际延迟取决于运营商和网络负载。",
    "features.heading": "为什么选择 NITRO VPN",
    "features.subheading": "解锁流媒体、消息应用和社交平台。新用户均可获得 2 天 1GB 免费试用。",
    "features.cardCinemaTitle": "KinoPoisk",
    "features.cardCinemaText": "在世界各地观看电影、剧集、电视直播与体育赛事。",
    "features.cardYoutubeTitle": "YouTube",
    "features.cardYoutubeText": "为 4K 视频和直播提供稳定高速。",
    "features.cardCallsTitle": "消息应用通话",
    "features.cardCallsText": "Telegram、WhatsApp、Viber、FaceTime 等语音视频通话*¹ 稳定清晰。",
    "features.cardInstagramTitle": "Instagram*²",
    "features.cardInstagramText": "发布与浏览内容不再受限。",
    "features.cardStealthTitle": "隐匿流量",
    "features.cardStealthText": "VLESS 流量与普通 HTTPS 无异，轻松避开封锁与 DPI。",
    "features.cardDevicesTitle": "一份订阅覆盖 4 台设备",
    "features.cardDevicesText": "iPhone、Android、Mac、Windows、Linux 任意四台设备同时在线。",
    "features.cardUnlimitedTitle": "无限流量",
    "features.cardUnlimitedText": "没有隐藏限额或突发限速。",
    "features.cardSpeedTitle": "高速稳定",
    "features.cardSpeedText": "莫斯科与里加节点优化，确保俄罗斯与欧洲地区低延迟。",
    "features.cardSupportTitle": "可靠客服",
    "features.cardSupportText": "99% 在线率，@nitro_vpn_help 客服几分钟内响应。",
    "features.note": "*¹ 语音通话需双方同时开启 VPN。<br>*² Instagram 隶属于 Meta，已在俄罗斯被定性为极端组织。",
    "protocol.heading": "VLESS —— 保持畅通的关键",
    "protocol.subheading": "VLESS 是新一代 VPN 协议，连接快速、稳定且难以被运营商察觉，热门服务自然畅通。",
    "protocol.cardWhatTitle": "它是什么",
    "protocol.cardWhatText": "VLESS 负责设备与 VPN 的通信，没有多余开销，几秒即可连接。",
    "protocol.cardFastTitle": "为什么更快",
    "protocol.cardFastText": "减少额外握手流程。无论视频、通话或游戏，多设备同时使用也流畅。",
    "protocol.cardStealthTitle": "为什么难以封锁",
    "protocol.cardStealthText": "流量就像普通网页访问，运营商无从下手，即使严苛封锁也能绕过。",
    "pricing.heading": "套餐与价格",
    "pricing.subheading": "提供 1/3/6/12 个月套餐。均包含 4 台设备、无限流量，以及莫斯科与里加服务器。",
    ...
    "pricing.note": "支持俄罗斯银行卡、SBP 或 Telegram Stars 支付。机器人会在到期前数日提醒续费。",
    "trial.heading": "免费试用",
    "trial.lead": "<b>新用户</b> 可获得 <b>2 天</b> <b>1GB</b> 免费流量。Telegram 一键激活，无需银行卡。",
    ...
    "trial.steps1": "打开 <a href=\"https://t.me/nitro_vpn_sales_bot\" target=\"_blank\" rel=\"noopener\">@nitro_vpn_sales_bot</a>。",
    ...
    "payments.subheading": "支持俄罗斯银行卡、SBP 与 Telegram Stars，付款后立即开通。",
    ...
    "faq.q2": "有速度限制吗？",
    "faq.a2": "每台服务器最高 2 Gbit/s，所有用户均分。实际速度取决于网络环境与距离。",
    "faq.q3": "试用如何使用？",
    "faq.a3": "免费获得 2 天 1GB，之后可升级任意套餐。",
    "faq.q4": "服务覆盖哪些地区？",
    "faq.a4": "目前提供 <b>莫斯科</b> 与 <b>里加</b> 节点，并持续扩展中。",
    "cta.heading": "准备好接入 NITRO VPN 了吗？",
    "cta.text": "购买、续费、试用和邀请奖励都在 Telegram 机器人中完成。客服：<a class=\"support-link\" href=\"https://t.me/nitro_vpn_help\" target=\"_blank\" rel=\"noopener\">@nitro_vpn_help</a>",
    "cta.primary": "打开 @nitro_vpn_sales_bot",
    "cta.secondary": "支付方式",
    "footer.copyright": "© <span id=\"year\"></span> NITRO VPN",
    "meta.title": "NITRO VPN — 在俄罗斯解锁 YouTube 和 Telegram 的 VLESS VPN",
    "meta.description": "畅享 YouTube、Instagram、TikTok、Telegram、WhatsApp 与 KinoPoisk。莫斯科与里加服务器，VLESS + TLS，2 天 1GB 免费试用，无限流量，支持 4 台设备。",
    "meta.keywords": "nitro vpn,vless vpn,vpn russia,vpn moscow,vpn riga,高速vpn,无限流量vpn,vpn youtube,vpn telegram,vpn instagram,vpn whatsapp,vpn twitter,vpn discord,绕过dpi",
    "meta.ogLocale": "zh_CN",
    "meta.ogTitle": "NITRO VPN — 解锁 YouTube 与 Telegram",
    "meta.ogDescription": "YouTube、Instagram、TikTok、Telegram、WhatsApp 全面解锁。莫斯科与里加服务器，2 天 1GB 免费试用。",
    "meta.ogImageAlt": "NITRO VPN 标志与界面",
    "meta.twitterTitle": "NITRO VPN — 稳定 VLESS VPN",
    "meta.twitterDescription": "免费试用 2 天 1GB。莫斯科与里加节点，高速无限流量，支持 4 台设备。",
    ...
    "lang.option.fa": "🇮🇷 波斯语",
    "lang.option.zh": "🇨🇳 简体中文",
    "toast.planSelected": "已选择套餐：{plan} — {price}。请在 Telegram 完成支付。",
    "schema.description": "NITRO VPN 是面向俄罗斯和欧洲的高速 VLESS VPN，提供莫斯科与里加服务器、2 天 1GB 免费试用、无限流量及最多 4 台设备。",
    "schema.moscow": "莫斯科",
    "schema.riga": "里加",
...
const applyTranslations = (lang) => {
  ...
  document.querySelectorAll("[data-i18n-attr]").forEach((el) => {
    ...
    const attrKey = el.getAttribute("data-i18n-attr-key") || el.getAttribute("data-i18n");
    if (attrName && attrKey) {
  ...
  if (schemaEl) {
    try {
      ...
      if (schema.offers) {
        const offerKeys = ["schema.offer1", "schema.offer3", "schema.offer6", "schema.offer12"];
      ...
      if (schema.offersCatalog && Array.isArray(schema.offersCatalog.itemListElement)) {
        schema.offersCatalog.name = getTranslation(lang, "schema.catalog");
        const catalogKeys = ["schema.offer1", "schema.offer3", "schema.offer6", "schema.offer12"];
      ...
      if (schema.hasOfferCatalog && Array.isArray(schema.hasOfferCatalog.itemListElement)) {
        const bonusKeys = ["schema.bonus1", "schema.bonus3", "schema.bonus6", "schema.bonus12"];
...
const showToast = (message) => {
  ...
  toastEl.style.background = "linear-gradient(135deg, var(--primary-600), var(--primary))";
...
const initPlanButtons = () => {
  document.querySelectorAll("[data-select]").forEach((btn) => {
    btn.addEventListener("click", (event) => {
      ...
      const message = template.replace("{plan}", planTitle).replace("{price}", priceText);
      showToast(message);
    });
  });
};
